...
//    }
    ...
    private fun updateName() {
        findViewById<TextView>(R.id.plain_name).text = viewModel.name.toString()
        findViewById<TextView>(R.id.plain_lastname).text = viewModel.lastName.toString()
    }
    ...
    private fun getAssociatedColor(popularity: LiveData<Popularity>, context: Context): Int {
